...
<title><?=$webName ?> | Nonton dan Streaming Anime Subtitle Indonesia</title>
<meta charset="UTF-8">
...
<meta name="description" content="Portal Download dan Streaming Anime Sub Indo Batch Fast loading Complete, Eps Lengkap, Ongoing dan Terbaru dalam Format  1080p Mkv 480p, 720p dan Mp4 240p, 360p 3GP dengan link Google Drive, Zippyshare, Meownime, Anitoki, Anoboy, Samhadaku, <?=$webName ?>." />
<meta property="og:type" content="website" />
<meta property="og:title" content="<?=$webName ?> | Nonton dan Streaming Anime Subtitle Indonesia" />
<meta property="og:description" content="Portal Download dan Streaming Anime Sub Indo Batch Fast loading Complete, Eps Lengkap, Ongoing dan Terbaru dalam Format  1080p Mkv 480p, 720p dan Mp4 240p, 360p 3GP dengan link Google Drive, Zippyshare, Meownime, Anitoki, Anoboy, Samhadaku, <?=$webName ?>." />
...
<span class="bg-gdark"><i class="fa fa-fire" aria-hidden="true"></i> Anime Update &gt;</a>
</div>
<?php
$json = file_get_contents("$apiLink/home");
$data = json_decode($json, true);
$data = $data["data"];
?>
<?php foreach ($data as $recentRelease) :
?>
<div class="bg-white shadow xrelated relative">
<a href="/anime/<?=$recentRelease ["id"] ?>"><img src="<?=$recentRelease ["thumbnail"] ?>?x5" alt="<?=$recentRelease ["title"] ?>" /><div class="eplist">
<?=$recentRelease ["episode"] ?>
</div>
